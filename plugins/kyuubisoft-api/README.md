...
2. Copy `build/libs/KyuubiSoftAPI-1.4.2.jar` to your server's `mods/` folder
...
jar --create --file build/libs/KyuubiSoftAPI-1.4.2.jar -C build/classes .
```

Output: `build/libs/KyuubiSoftAPI-1.4.2.jar`
