  ...
  <div ref="containerRef" class="relative">
    <div class="relative">
      <input
        ...
        :disabled="disabled"
        class="w-full px-4 py-2 bg-surface-overlay border border-border rounded-lg text-ink placeholder-gray-500 focus:outline-none focus:border-hytale-orange pr-8"
        @input="handleInput"
