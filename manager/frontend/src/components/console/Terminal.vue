    ...
    <div class="flex items-center gap-3 mb-3 flex-shrink-0">
      ...
      <div class="relative flex-1">
        <input
          ...
          class="w-full pl-9 pr-4 py-2 bg-surface-overlay border border-border rounded-lg text-ink text-sm placeholder-gray-500 focus:outline-none focus:border-hytale-orange"
        />
