  ...
  <header class="h-16 bg-dark-200 border-b border-dark-50/50 flex items-center justify-between px-4 sm:px-6">
    ...
    <div class="flex items-center gap-2 sm:gap-4">
      ...
      <button
        ...
        class="p-2 rounded-lg text-gray-400 hover:text-hytale-orange hover:bg-dark-50 transition-colors flex items-center justify-center"
      >
        <svg v-if="themeStore.theme === 'dark'" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
