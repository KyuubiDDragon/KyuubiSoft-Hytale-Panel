...
<template>
  <div>
    ...
    <!-- Empty State -->
    <div v-else-if="players.length === 0" class="text-center text-ink-subtle p-8">
      {{ t('players.noPlayers') }}
    </div>
    ...
    <div v-else class="divide-y divide-border/30">
      ...
      >
        ...
        <div
          ...
          class="flex items-center justify-between p-4 cursor-pointer hover:bg-surface-overlay/30 transition-colors"
        >
        ...
        <div
          ...
          class="px-4 pb-4 bg-surface-overlay/50"
        >
          <!-- Quick Actions -->
          <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mb-4">
            <button
              @click.stop="emit('kick', player.name)"
              class="flex items-center justify-center gap-2 px-4 py-3 bg-surface-overlay rounded-lg text-ink-muted hover:bg-status-warning/20 hover:text-status-warning transition-colors"
            >
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-surface-overlay rounded-lg text-ink-muted hover:bg-status-error/20 hover:text-status-error transition-colors"
            >
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-surface-overlay rounded-lg text-ink-muted hover:bg-hytale-orange/20 hover:text-hytale-orange transition-colors"
            >
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              class="flex items-center justify-center gap-2 px-4 py-3 bg-surface-overlay rounded-lg text-ink-muted hover:bg-purple-500/20 hover:text-purple-400 transition-colors"
            >
              <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
