...
<template>
  <div class="space-y-6">
    ...
    <div class="text-center">
      ...
      <h2 class="text-2xl font-bold text-ink mb-2">{{ t('setup.securitySettingsTitle') }}</h2>
      <p class="text-ink-muted">{{ t('setup.securitySettingsDescription') }}</p>
    </div>
      ...
      <div>
        ...
        <div class="relative">
          ...
          <button
            ...
            class="absolute right-3 top-3 text-ink-muted hover:text-ink"
          >
        ...
        <div class="flex items-start gap-4">
          <div class="flex-shrink-0 pt-1">
            <button
              ...
              :class="whitelistEnabled ? 'bg-hytale-orange' : 'bg-surface-overlay'"
            >
              <span
          ...
          <div class="flex-1">
            <div class="flex items-center gap-2">
              <span class="font-medium text-ink">{{ t('setup.whitelistEnabled') }}</span>
        ...
        <div class="flex items-start gap-4">
          <div class="flex-shrink-0 pt-1">
            <button
              ...
              class="relative inline-flex h-6 w-11 items-center rounded-full transition-colors"
              :class="allowOperator ? 'bg-hytale-orange' : 'bg-surface-overlay'"
            >
              <span
                class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform"
          ...
          <div class="flex-1">
            <div class="flex items-center gap-2">
              <span class="font-medium text-ink">{{ t('setup.allowOperator') }}</span>
            </div>
            <p class="mt-1 text-sm text-ink-muted">
      ...
      <div class="p-4 bg-surface-muted rounded-lg border border-border/60">
        <div class="flex items-start gap-3">
          ...
          <div class="text-sm text-ink-muted">
            <p class="font-medium text-ink-muted mb-1">{{ t('setup.securityTipsTitle') }}</p>
