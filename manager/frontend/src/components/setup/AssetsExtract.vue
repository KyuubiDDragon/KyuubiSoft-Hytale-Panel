        ...
        <div class="card-body">
          ...
          <div class="mb-4">
            <div class="flex items-center justify-between mb-2">
              <span class="text-white font-medium">{{ t('setup.extractionProgress') }}</span>
              <span class="text-gray-400 text-sm">{{ extractionProgress.percent }}%</span>
            </div>
            <div class="h-3 bg-dark-50 rounded-full overflow-hidden">
              <div
                class="h-full bg-hytale-orange transition-all duration-300"
          ...
          <div class="grid grid-cols-2 gap-4 text-sm">
            <!-- Current File -->
            <div class="col-span-2 p-3 bg-dark-300 rounded-lg">
              <div class="flex items-center gap-2 text-gray-400 mb-1">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span>{{ t('setup.currentFile') }}</span>
              </div>
              <p class="text-gray-300 truncate font-mono text-xs">
            ...
            <div class="p-3 bg-dark-300 rounded-lg">
              <div class="flex items-center gap-2 text-gray-400 mb-1">
                ...
                <span>{{ t('setup.filesExtracted') }}</span>
              </div>
              <p class="text-white font-medium">
                {{ formatNumber(extractionProgress.filesDone) }} / {{ formatNumber(extractionProgress.filesTotal) }}
              </p>
            </div>
            ...
            <div class="p-3 bg-dark-300 rounded-lg">
              <div class="flex items-center gap-2 text-gray-400 mb-1">
                ...
                <span>{{ t('setup.sizeExtracted') }}</span>
              </div>
              <p class="text-white font-medium">
                {{ formatBytes(extractionProgress.bytesDone) }} / {{ formatBytes(extractionProgress.bytesTotal) }}
              </p>
            </div>
            ...
            <div class="col-span-2 p-3 bg-dark-300 rounded-lg">
              <div class="flex items-center gap-2 text-gray-400 mb-1">
                ...
                <span>{{ t('setup.estimatedTime') }}</span>
              </div>
              <p class="text-white font-medium">
                ~{{ formatTime(extractionProgress.estimatedSeconds) }} {{ t('setup.remaining') }}
              </p>
            </div>
          </div>
        </div>
